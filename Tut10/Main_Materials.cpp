...
int main(int argc, char **argv)
{
	...
	Shader cubeShader("CubeVertexShader_Materials.vs", "CubeFragmentShader_Materials.fs");
...
void renderScene()
{
	...
	GLint matAmbientLoc = glGetUniformLocation(cubeShaderPtr->Program, "material.ambient");
	GLint matDiffuseLoc = glGetUniformLocation(cubeShaderPtr->Program, "material.diffuse");
